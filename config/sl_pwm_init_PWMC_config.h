...
// $[TIMER_SL_PWM_PWMC]
#define SL_PWM_PWMC_PERIPHERAL                   TIMER2
#define SL_PWM_PWMC_PERIPHERAL_NO                2

#define SL_PWM_PWMC_OUTPUT_CHANNEL               0
// TIMER2 CC0 on PB03
#define SL_PWM_PWMC_OUTPUT_PORT                  gpioPortB
#define SL_PWM_PWMC_OUTPUT_PIN                   3
// [TIMER_SL_PWM_PWMC]$
