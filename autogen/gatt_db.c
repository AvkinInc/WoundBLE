...
{
  0x73, 0x7c, 0x7e, 0xb0, 0xbd, 0xe9, 0x31, 0x83, 0xaa, 0x4d, 0xd1, 0x73, 0x0a, 0x47, 0x3f, 0x36, 
  0x2c, 0x9c, 0x95, 0xa8, 0xbe, 0xba, 0x40, 0x89, 0xe4, 0x4c, 0x7b, 0x73, 0x69, 0x58, 0x14, 0xbc, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_26) = {
  .len = 12,
  .data = { 0x46, 0x53, 0x52, 0x32, 0x20, 0x52, 0x65, 0x61, 0x64, 0x69, 0x6e, 0x67, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_22) = {
  .len = 12,
  .data = { 0x46, 0x53, 0x52, 0x31, 0x20, 0x52, 0x65, 0x61, 0x64, 0x69, 0x6e, 0x67, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_18) = {
  .len = 16,
  .data = { 0xed, 0xb5, 0x6d, 0xb7, 0x11, 0xbf, 0xd6, 0xbe, 0xad, 0x4d, 0x5f, 0xd4, 0x8c, 0xe5, 0x7c, 0xd4, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 13,
  .data = { 0x41, 0x76, 0x77, 0x6f, 0x75, 0x6e, 0x64, 0x42, 0x4c, 0x45, 0x00, 0x00, 0x00, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x14, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x32, .char_uuid = 0x8000 } },
  ...
  { .handle = 0x18, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x32, .char_uuid = 0x8001 } },
  { .handle = 0x19, .uuid = 0x8001, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x02, .dynamicdata = &gattdb_attribute_field_24 },
